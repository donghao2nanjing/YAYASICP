...
(define (find_divisor n d)
    (cond ((> (square d) n) n)
        ((divides? d n) d) 
        (else (find_divisor n (next_divisor d)))
    )
)

(define (next_divisor d) 
    (cond
        ((= d 2) 3)
        (else (+ d 2))
    )
...
;;; Results: 
; It is prime, elapsed time is:2698 number: 100000000003
; It is prime, elapsed time is:2995 number: 100000000019
; It is prime, elapsed time is:2001 number: 100000000057

; It is prime, elapsed time is:7998 number: 1000000000039
; It is prime, elapsed time is:8034 number: 1000000000061
; It is prime, elapsed time is:8026 number: 1000000000063

; It is prime, elapsed time is:29995 number: 10000000000037
; It is prime, elapsed time is:27031 number: 10000000000051
; It is prime, elapsed time is:25995 number: 10000000000099

;;; Observed ratio is less than 2.
;;; Why? I don't know for sure. 
;;; Guess that's because the time for divide? to run differs between odd and even inputs.